...
@export_route.route('/object/<string:public_ids>/<string:export_class>', methods=['GET'])
@login_required
...
@export_route.route('/object/type/<int:public_id>/<string:export_class>', methods=['GET'])
@login_required
